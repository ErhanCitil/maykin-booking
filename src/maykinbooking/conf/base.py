...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "maykinbooking"),
        "USER": config("DB_USER", "maykinbooking"),
        "PASSWORD": config("DB_PASSWORD", "maykinbooking"),
...
ROOT_URLCONF = "maykinbooking.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "maykinbooking.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "maykinbooking.wsgi.application"
...
DEFAULT_FROM_EMAIL = "maykinbooking@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "maykinbooking.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "maykinbooking.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "maykinbooking_sessionid"
...
CSRF_FAILURE_VIEW = "maykinbooking.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "maykinbooking.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"maykinbooking {ENVIRONMENT}",
