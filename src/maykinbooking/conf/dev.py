...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-hjafzqtg!)^h8mqn9pd6+@$b7bc_+ksu$*=agg(g&$&_jcxwdp",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "maykinbooking")
os.environ.setdefault("DB_USER", "maykinbooking")
os.environ.setdefault("DB_PASSWORD", "maykinbooking")
